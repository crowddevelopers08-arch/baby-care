...
const CheckIcon = () => (
  <svg width="21" height="21" viewBox="0 0 24 24" fill="none" className="mt-0.5 flex-shrink-0" aria-hidden="true">
    <path d="M5 12.2l4 4L19 7" stroke="var(--color-brand)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
    ...
    <section id="special-needs" className="relative w-full overflow-hidden bg-white py-0 max-sm:pt-6 md:py-10">
      ...
      <div className="relative mx-auto max-w-7xl px-6 md:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mx-auto max-sm:mt-3 mt-7 max-w-5xl text-center text-[1rem] font-semibold leading-8 text-muted md:text-[1.08rem]">
          ...
          <div className="mt-10 max-sm:mt-5 rounded-[28px] border border-mist bg-white/90 p-6 shadow-[0_20px_60px_rgba(219,48,86,0.08)] md:p-8">
            <h3
              className="max-w-5xl font-black leading-tight text-ink"
            ...
            <div className="mt-8 border-t border-mist pt-8">
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {visibleNeeds.map((item) => (
                  <div
                    key={item}
                    className="flex items-start gap-3 rounded-2xl bg-white px-4 py-3 text-[0.95rem] font-semibold leading-snug text-graphite md:text-[1rem]"
                  >
                    <CheckIcon />
                    <span>{item}</span>
                  </div>
              ...
              <div className="mt-7 flex justify-center">
                <button
                  ...
                  className="cursor-pointer rounded-full bg-azure px-7 py-3 text-sm font-black uppercase tracking-[0.12em] text-white shadow-lg shadow-azure/25 transition-all hover:-translate-y-0.5 hover:bg-aqua"
                >
