...
const StarIcon = () => (
  <svg width="19" height="19" viewBox="0 0 24 24" fill="#e91e8c" aria-hidden="true">
...
function TestimonialCard({ item }: { item: (typeof testimonials)[number] }) {
  return (
    <article  className="testimonial-card relative bg-[#fff5f8] px-5 pb-7 pt-7 shadow-[0_18px_45px_rgba(233,30,140,0.10)] transition-transform duration-300 hover:-translate-y-1 sm:px-10 sm:pb-9 sm:pt-10">
      <div className="flex items-start gap-4 sm:gap-7">
        <div className="h-[78px] w-[78px] flex-shrink-0 rounded-full border-[3px] border-dotted border-[#e91e8c] bg-white p-[7px] sm:h-[92px] sm:w-[92px] sm:p-[8px]">
          <div
        ...
        <div className="min-w-0 pt-1">
          <h3
            className="text-xl font-black leading-tight text-[#1a1f5e] sm:text-2xl"
          >
            {item.name}
          </h3>
          <p className="mt-1 text-sm font-semibold leading-none text-gray-500 sm:mt-2 sm:text-base">{item.profession}</p>
      ...
      <div className="mt-6 h-px w-full bg-[#e91e8c]/70 sm:mt-8" />

      <p className="mt-4 text-[0.9rem] leading-7 text-gray-600 sm:mt-5 sm:text-[0.97rem] sm:leading-relaxed">
        {item.text}
      </p>
    </article>
  );
...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" className="relative w-full overflow-hidden py-8 md:py-14">
      ...
      />
      <div
        className="absolute inset-0 bg-gradient-to-br from-white/90 via-[#fff5f8]/88 to-white/92"
        aria-hidden="true"
      />
      <div className="pointer-events-none absolute -left-28 top-8 h-80 w-80 rounded-full bg-pink-100/50 blur-3xl" />
      <div className="pointer-events-none absolute -right-28 bottom-8 h-80 w-80 rounded-full bg-blue-100/40 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-6 md:px-12">
        <div className="text-center">
          <div className="inline-block">
            <p
              className="font-bold leading-none text-[#e91e8c]"
              style={{
                fontSize: "1.15rem",
              }}
            >
          ...
          <h2
            className="mt-4 font-black leading-tight text-[#1a1f5e]"
            style={{
        ...
        <div className="mt-10 md:hidden">
          <div className="relative mx-auto max-w-[390px] px-2">
            <button
              ...
              className="absolute left-[-13px] top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-[#e91e8c] text-white shadow-lg shadow-pink-200/70"
            ...
            <button
              type="button"
              onClick={goToNext}
              className="absolute right-[-10px] top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-[#e91e8c] text-white shadow-lg shadow-pink-200/70"
        ...
        <div className="mt-9 flex items-center justify-center gap-3">
          <span className="h-3.5 w-8 rounded-full bg-[#3b4fa8]" />
          <span className="h-3.5 w-3.5 rounded-full bg-[#e91e8c]" />
          <span className="h-3.5 w-3.5 rounded-full bg-[#e91e8c]" />
        </div>
